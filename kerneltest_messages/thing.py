...
from .base import SCHEMA_URL, kerneltestMessage, THING_SCHEMA


class NewThingV1(kerneltestMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by kerneltest when a new thing is created.
    """

    topic = "kerneltest.new"
